...
dataset_path = r'C:\Users\syazw\Desktop\BTI3423 MACHINE VISION\Project\fer2013plus\fer2013'
...
test_generator = datagen.flow_from_directory(
    dataset_path + '/test',  # assuming you have a 'test' folder in your dataset directory
    target_size=(img_width, img_height),
    batch_size=batch_size,
    class_mode='categorical')

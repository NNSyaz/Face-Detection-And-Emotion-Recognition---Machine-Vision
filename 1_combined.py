# -*- coding: utf-8 -*-
"""
Created on Sun Dec 17 00:56:37 2023
...
def detect_emotions(image_path):
    ...
    #Detects faces in the grayscale image using Haar cascade classifier
    faces = face_cascade.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=5, minSize=(30, 30))
    
    #Iterates through the detected faces
    for (x, y, w, h) in faces:
        face_roi = gray[y:y + h, x:x + w] # Extract face region in grayscale
        ...
        # Match the predicted emotion index to the predefines list of emotions
...
detect_emotions(r"C:\Users\syazw\Desktop\BTI3423 MACHINE VISION\Project\Project Face Detection & Emotion Recognition\4.jpg") 
